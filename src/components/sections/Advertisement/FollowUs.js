...
const FollowUs = () => {
  return (
    <div className='main'>
      <h5>Gündeme Dair Her Şey uygulamamızı indirerek yakından takip edebilirsiniz</h5>
      <div className='buttons'>
        <SocialButton IconComponent={PlayStoreIcon} text1="GET IT ON" text2="Google Play"/>
        <SocialButton IconComponent={AppleIcon} text1="Download on the" text2="App Store"/>
      </div>
      <div className='social-button-container'>
        ...
        <div className='social-buttons'>
            ...
            <SoundCloudIcon size="14px" color="white" margin="0 4px" padding="0"/>
            <ApplePodcastsIcon size="14px" color="white" margin="0 4px" padding="0"/>
        </div>
      </div>
    </div>
  )
